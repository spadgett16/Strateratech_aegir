...
projects[superfish][version] = "1.9+33-dev"
...
; Please fill the following out. Type may be one of get, git, bzr or svn,
; and url is the url of the download.
projects[helloworld][subdir][type] = "custom"
projects[helloworld][download][type] = "git"
projects[helloworld][type] = "module"
projects[helloworld][download][url] = "git@github.com:spadgett16/Strateratech_aegir.git"
projects[helloworld][type] = "module"
